    ...
    <>
      <main className="flex-1 w-full px-6 lg:px-10 py-8">
        ...
        {stats?.difficultyBreakdown && Object.keys(stats.difficultyBreakdown).length > 0 && (
          <div className="mt-6 p-4 border border-[#2a2a30] rounded-xl bg-[#141416]">
              ...
              <div className="space-y-2">
                {stats.upcomingContests.map((c: any) => (
                  <Link
                    ...
                    className="block p-3 rounded-lg border border-[#2a2a30] hover:border-rf-gray transition-colors"
                  >
              ...
              <div className="space-y-2">
                {stats.recentSubmissions.map((s: any) => (
                  <Link
                    ...
                    className="flex items-center justify-between p-2 rounded-lg hover:bg-[#22222a] transition-colors"
                  >
                    <div>
        ...
        <div className="mt-6 flex gap-3">
          <Link
            href="/problems"
            className="px-4 py-2 text-sm font-medium bg-[#22222a] hover:bg-rf-iron text-white rounded-lg transition-colors"
          >
            Practice Problems
          </Link>
          <Link
