    ...
    <>
      <main className="flex-1 w-full px-6 lg:px-10 py-8">
        <div className="flex items-center justify-between mb-6">
          <h1 className="text-2xl font-bold text-[var(--c-fg)]">Contests</h1>
          <Link
            href="/contests/create"
            className="px-4 py-2 text-xs uppercase tracking-wide font-medium bg-[var(--c-fg)] hover:opacity-80 text-[var(--c-bg)] transition-colors"
          >
            Create Contest
          </Link>
        </div>
            ...
            <div className="space-y-3">
              {data.contests.map((contest: any) => (
                <Link
                  ...
                  className="block p-5 rounded-xl border border-[var(--c-border-2)] bg-[var(--c-surface)] hover:border-rf-gray transition-colors"
                >
                  <div className="flex items-start justify-between">
                    <div>
                      <div className="flex items-center gap-3 mb-1">
                        <h2 className="text-lg font-semibold text-[var(--c-fg)]">
                          {contest.title}
                        </h2>
