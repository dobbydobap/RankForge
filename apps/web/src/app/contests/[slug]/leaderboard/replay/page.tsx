    ...
    <>
      <main className="flex-1 w-full px-6 lg:px-10 py-8">
        <div className="flex items-center justify-between mb-4">
          <div>
            <h1 className="font-display text-3xl sm:text-4xl uppercase tracking-tight text-[var(--c-fg)]">Contest Replay</h1>
              ...
              <button
                ...
                className={`px-2 py-1 text-xs rounded ${
                  speed === s
                    ...
                    : 'bg-[var(--c-surface-3)] text-rf-gray hover:bg-rf-iron'
                } transition-colors`}
              >
                {s}x
              </button>
        ...
        {currentFrame && (
          <div className="border border-[var(--c-border-2)] rounded-xl overflow-hidden">
            <div className="px-4 py-2 bg-[var(--c-surface)] border-b border-[var(--c-border-2)]">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-[var(--c-border-2)] bg-rf-dark/30">
                  ...
                  .map((entry: any, idx: number) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 py-2.5 text-sm text-[var(--c-fg)]">
                          {entry.displayName || entry.username}
                        </td>
                        <td className="text-center px-3 py-2.5 text-sm font-bold text-[var(--c-fg)]">
                          {entry.score}
                        </td>
