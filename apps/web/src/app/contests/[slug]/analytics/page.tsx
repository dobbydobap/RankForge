      ...
      <main className="flex-1 w-full px-6 lg:px-10 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          ...
          <div className="p-4 border border-[var(--c-border-2)] rounded-xl bg-[var(--c-surface)]">
            ...
            <p className="text-2xl font-bold text-[var(--c-fg)]">{myAnalytics.summary.totalScore}</p>
          </div>
          <div className="p-4 border border-[var(--c-border-2)] rounded-xl bg-[var(--c-surface)]">
            <p className="text-xs text-rf-gray">Participants</p>
            <p className="text-2xl font-bold text-[var(--c-fg)]">{myAnalytics.totalParticipants}</p>
          </div>
        ...
        <div className="border border-[var(--c-border-2)] rounded-xl overflow-hidden mb-6">
            ...
            <tbody className="divide-y divide-[var(--c-border-2)]">
              {myAnalytics.problemBreakdown.map((p: any) => (
                <tr key={p.label} className="hover:bg-[var(--c-surface)] transition-colors">
                  ...
                  <td className="px-4 py-3 text-sm text-[var(--c-fg)]">{p.title}</td>
          ...
          <div className="h-48">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <Bar dataKey="solveTime" fill="#8a8a98" name="Your Time (min)" />
