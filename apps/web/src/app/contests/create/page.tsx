  ...
  return (
    <>
      <main className="flex-1 w-full max-w-3xl px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full px-3 py-2 bg-rf-dark border border-rf-iron rounded-lg text-[var(--c-fg)] placeholder-rf-iron focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 bg-rf-dark border border-rf-iron rounded-lg text-[var(--c-fg)] focus:outline-none focus:ring-2 focus:ring-orange-500"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-orange-400 mb-1">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-4 h-4 rounded bg-rf-dark border-rf-iron text-orange-400 focus:ring-orange-500"
            />
            <label htmlFor="isPublic" className="text-sm text-orange-400">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-2.5 text-xs uppercase tracking-wide font-medium bg-[var(--c-fg)] hover:opacity-80 disabled:opacity-50 text-[var(--c-bg)] transition-colors"
            >
              {submitting ? 'Creating...' : 'Create Contest'}
            </button>
            <Link
              href="/contests"
              className="px-6 py-2.5 text-sm font-medium border border-rf-iron hover:border-rf-gray text-orange-400 rounded-lg transition-colors"
            >
              Cancel
            </Link>
          </div>
        ...
        <div className="mt-8 p-4 border border-[var(--c-border-2)] rounded-xl bg-[var(--c-surface)]">
