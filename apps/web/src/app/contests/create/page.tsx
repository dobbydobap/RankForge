  ...
  return (
    <>
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          <h1 className="text-2xl font-bold text-zinc-100">Create Contest</h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="flex gap-3 pt-2">
            <button
              type="submit"
              disabled={submitting}
              className="px-6 py-2.5 text-sm font-medium bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white rounded-lg transition-colors"
            >
              {submitting ? 'Creating...' : 'Create Contest'}
            </button>
            <Link
              href="/contests"
              className="px-6 py-2.5 text-sm font-medium border border-zinc-700 hover:border-zinc-500 text-zinc-300 rounded-lg transition-colors"
            >
              Cancel
            </Link>
          </div>
        ...
        <div className="mt-8 p-4 border border-zinc-800 rounded-xl bg-zinc-900/50">
          <h3 className="text-sm font-semibold text-zinc-300 mb-2">After creating:</h3>
