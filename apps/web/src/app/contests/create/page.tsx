    ...
    <>
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="block text-sm font-medium text-rf-pink mb-1">
              Contest Title *
            </label>
            <input
              type="text"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <input
                ...
                required
                className="w-full px-3 py-2 bg-rf-dark border border-rf-iron rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-rf-sage"
              />
            </div>
            <div>
              <label className="block text-sm font-medium text-rf-pink mb-1">
          ...
          <div className="flex items-center gap-3">
            <input
              ...
              className="w-4 h-4 rounded bg-rf-dark border-rf-iron text-rf-pink focus:ring-rf-sage"
            />
            <label htmlFor="isPublic" className="text-sm text-rf-pink">
          ...
          <div className="flex gap-3 pt-2">
            ...
            <Link
              href="/contests"
              className="px-6 py-2.5 text-sm font-medium border border-rf-iron hover:border-rf-gray text-rf-pink rounded-lg transition-colors"
            >
              Cancel
            </Link>
          </div>
        ...
        <div className="mt-8 p-4 border border-rf-border rounded-xl bg-rf-dark/50">
          <h3 className="text-sm font-semibold text-rf-pink mb-2">After creating:</h3>
