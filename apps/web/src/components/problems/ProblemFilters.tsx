  ...
  return (
    <div className="flex flex-col sm:flex-row gap-3">
      <input
        ...
        className="flex-1 px-3 py-2 bg-rf-dark border border-rf-iron rounded-lg text-[var(--c-fg)] placeholder-rf-iron focus:outline-none focus:ring-2 focus:ring-orange-500 focus:border-transparent text-sm"
      />
      <select
        value={difficulty}
