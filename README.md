...
![NestJS](https://img.shields.io/badge/NestJS-11-black)
![PRs welcome](https://img.shields.io/badge/PRs-welcome-black.svg)
...
Monochrome **brutalist / editorial** UI — oversized display type, hairline rules,
sharp corners, and big negative space. Fully **light / dark themed** via a single
toggle (top-right corner); the entire app flips through CSS variables.
...
Theming is driven by semantic CSS variables (`--c-bg`, `--c-fg`, `--c-surface`, `--c-border`, …) defined for both themes in [`apps/web/src/app/globals.css`](apps/web/src/app/globals.css), so every component flips automatically.
...
[CONTRIBUTING.md](CONTRIBUTING.md) for setup and guidelines, and check the
[Issues](../../issues) tab — issues labeled `good first issue` and `help wanted`
are a great place to start.

## License

[MIT](LICENSE) © 2026 dobbydobap
